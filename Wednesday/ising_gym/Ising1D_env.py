...
class Ising1DEnv(gym.Env):
    ...
    def __init__(self):
        ...
        self.action_history = []  # keep track of actions to see which actions led to a slution
    ...
    def step(self, action):
        ...
        # remember action for printing out how the solution was found
    ...
    def reward(self):
        ...
        if done:
            ...
            print("I started from")
            print(self.state_to_str(self.start_config))
            print("and took the actions")
